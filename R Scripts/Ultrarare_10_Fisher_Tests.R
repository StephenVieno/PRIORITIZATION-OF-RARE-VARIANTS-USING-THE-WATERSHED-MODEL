...
total <- c(gene_symbols$Symbol, gene_list1$Symbol) |> unique() |> length()
# Total for Case Status 
total_filtered <- unique(uv_data_symbol$Symbol) |> length()

ifelse(unique(gene_list1$Symbol) %in% unique(uv_data_symbol$Symbol), 1, 0) |> table()
# Number of Shizophrenia genes from Common Variant studies in produced gene list (MAF < 10)
count1 <- ifelse(unique(gene_list1$Symbol) %in% unique(uv_data_symbol$Symbol), 1, 0) |> sum()
# Number of Shizophrenia genes from Common Variant studies not in produced gene list (MAF < 10)
count2 <- ifelse(unique(gene_list1$Symbol) %in% unique(uv_data_symbol$Symbol), 0, 1) |> sum()
# Number of Shizophrenia genes from Common Variant studies in produced gene list (MAF < 10)
count1
# Number of Shizophrenia genes from Common Variant studies not in produced gene list (MAF < 10)
count2

ifelse(unique(uv_data_symbol$Symbol) %in% unique(gene_list1$Symbol), 1, 0) |> table()
# Number of genes from produced gene list (MAF < 10) not in Shizophrenia genes from Common Variant studies
count3 <- ifelse(unique(uv_data_symbol$Symbol) %in% unique(gene_list1$Symbol), 0, 1) |> sum()
# Number of genes from produced gene list (MAF < 10) not in Shizophrenia genes from Common Variant studies
count3

unique(uv_data_symbol$Symbol) |> length()
...
# Total Number of Genes Symbols 
total <- c(gene_symbols$Symbol, gene_list2$Symbol) |> unique() |> length()
# Total for Case Status 
total_filtered <- unique(uv_data_symbol$Symbol) |> length()

ifelse(unique(gene_list2$Symbol) %in% unique(uv_data_symbol$Symbol), 1, 0) |> table()
# Number of Shizophrenia genes from Common Variant studies in produced gene list (MAF < 10)
count1 <- ifelse(unique(gene_list2$Symbol) %in% unique(uv_data_symbol$Symbol), 1, 0) |> sum()
# Number of Shizophrenia genes from Common Variant studies not in produced gene list (MAF < 10)
count2 <- ifelse(unique(gene_list2$Symbol) %in% unique(uv_data_symbol$Symbol), 0, 1) |> sum()
# Number of Shizophrenia genes from Common Variant studies in produced gene list (MAF < 10)
count1
# Number of Shizophrenia genes from Common Variant studies not in produced gene list (MAF < 10)
count2

ifelse(unique(uv_data_symbol$Symbol) %in% unique(gene_list2$Symbol), 1, 0) |> table()
# Number of genes from produced gene list (MAF < 10) not in Shizophrenia genes from Common Variant studies
count3 <- ifelse(unique(uv_data_symbol$Symbol) %in% unique(gene_list2$Symbol), 0, 1) |> sum()
# Number of genes from produced gene list (MAF < 10) not in Shizophrenia genes from Common Variant studies
count3
...
# Total Number of Genes Symbols 
total <- c(gene_symbols$Symbol, gene_list3$Symbol) |> unique() |> length()
# Total for Case Status 
total_filtered <- unique(uv_data_symbol$Symbol) |> length()

ifelse(unique(gene_list3$Symbol) %in% unique(uv_data_symbol$Symbol), 1, 0) |> table()
# Number of Shizophrenia genes from Common Variant studies in produced gene list (MAF < 10)
count1 <- ifelse(unique(gene_list3$Symbol) %in% unique(uv_data_symbol$Symbol), 1, 0) |> sum()
# Number of Shizophrenia genes from Common Variant studies not in produced gene list (MAF < 10)
count2 <- ifelse(unique(gene_list3$Symbol) %in% unique(uv_data_symbol$Symbol), 0, 1) |> sum()
# Number of Shizophrenia genes from Common Variant studies in produced gene list (MAF < 10)
count1
# Number of Shizophrenia genes from Common Variant studies not in produced gene list (MAF < 10)
count2

ifelse(unique(uv_data_symbol$Symbol) %in% unique(gene_list3$Symbol), 1, 0) |> table()
# Number of genes from produced gene list (MAF < 10) not in Shizophrenia genes from Common Variant studies
count3 <- ifelse(unique(uv_data_symbol$Symbol) %in% unique(gene_list3$Symbol), 0, 1) |> sum()
# Number of genes from produced gene list (MAF < 10) not in Shizophrenia genes from Common Variant studies
count3
...
# Total Number of Genes Symbols 
total <- c(gene_symbols$Symbol, gene_list4$Symbol) |> unique() |> length()
# Total for Case Status 
total_filtered <- unique(uv_data_symbol$Symbol) |> length()

ifelse(unique(gene_list4$Symbol) %in% unique(uv_data_symbol$Symbol), 1, 0) |> table()
# Number of Shizophrenia genes from Common Variant studies in produced gene list (MAF < 10)
count1 <- ifelse(unique(gene_list4$Symbol) %in% unique(uv_data_symbol$Symbol), 1, 0) |> sum()
# Number of Shizophrenia genes from Common Variant studies not in produced gene list (MAF < 10)
count2 <- ifelse(unique(gene_list4$Symbol) %in% unique(uv_data_symbol$Symbol), 0, 1) |> sum()
# Number of Shizophrenia genes from Common Variant studies in produced gene list (MAF < 10)
count1
# Number of Shizophrenia genes from Common Variant studies not in produced gene list (MAF < 10)
count2

ifelse(unique(uv_data_symbol$Symbol) %in% unique(gene_list4$Symbol), 1, 0) |> table()
# Number of genes from produced gene list (MAF < 10) not in Shizophrenia genes from Common Variant studies
count3 <- ifelse(unique(uv_data_symbol$Symbol) %in% unique(gene_list4$Symbol), 0, 1) |> sum()
# Number of genes from produced gene list (MAF < 10) not in Shizophrenia genes from Common Variant studies
count3
